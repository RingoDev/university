...
public class Scanner {
	...
	static {
		...
		literals.put("open", new Integer(7));
		literals.put("active", new Integer(8));
		literals.put("done", new Integer(9));
	...
	Token NextToken() {
		...
		loop: for (;;) {
			switch (state) {
				...
				case 21:
					recEnd = pos; recKind = 6;
					if (ch >= 'a' && ch <= 'z') {AddCh(); state = 13; break;}
					else if (ch >= '0' && ch <= '9') {AddCh(); state = 22; break;}
